...
(function (window, document, $) {
    ...
    if ($(body).hasClass("horizontal-layout")) {
        $("#customizer-navbar-colors .color-box.bg-white")
            ...
            .hide();
        $("#customizer-navbar-colors .color-box.bg-primary").addClass(
            "selected"
        );
    ...
    $("#footer-hidden").on("click", function () {
        ...
        body.removeClass("footer-static fixed-footer").addClass(
            "footer-hidden"
        );
    });
    ...
    $("#footer-static").on("click", function () {
        ...
        body.removeClass("footer-hidden fixed-footer").addClass(
            "footer-static"
        );
    });
